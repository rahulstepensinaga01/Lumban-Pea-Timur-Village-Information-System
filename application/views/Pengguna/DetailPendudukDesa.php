...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Detail Penduduk Desa</h6>
        </div>
        <div class="card-body">
        ...
        <div class="card-footer">
            <a href="<?= base_url('Pengguna/DaftarPendudukDesa') ?>"><button type="button" class="btn btn-secondary float-left">Kembali</button></a>
        </div>
    </div>
