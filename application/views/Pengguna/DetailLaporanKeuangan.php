        ...
        <div class="card-body">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9 mt-2">
                    ...
                    <a href="<?= base_url(); ?>Pengguna/download/<?= $detailpemasukan['id_keuangan']; ?>" class="badge badge-primary bg-info float-right"><i class="fas fa-download"></i></a>
                </div>
            </div>
        </div>
        <div class="card-footer">
            <a href="<?= base_url('Pengguna/LaporanKeuangan') ?>"><button type="button" class="btn btn-secondary float-left">Kembali</button></a>
        </div>
    </div>
