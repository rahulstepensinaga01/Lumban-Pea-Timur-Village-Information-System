...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4 text-center">
        ...
        <div class="card-footer">
            <a href="<?= base_url('Pengguna/DaftarPengumuman') ?>"><button type="button" class="btn btn-secondary float-left">Kembali</button></a>
        </div>
    </div>
    <form action="<?= base_url('Pengguna/tambahkomentar'); ?>" method="POST">
                        ...
                        <?php if ($tb_akun['nik'] == $komen['nik']) { ?>
                            ...
                            <div class="card-body">
                                <div class="mt-3">
                                    ...
                                    <a href="<?= base_url('Pengguna/hapuskomentar/') . $komen['id_komentar'] ?>" class="badge badge-danger float-right" onclick="return confirm('Yakin ingin menghapus Komentar?');">Hapus</a>
                                    <a href="<?= base_url('Pengguna/editkomentar/') . $komen['id_komentar']; ?>" class="badge badge-success float-right mb-3 mr-3">Edit</a>
                                    <hr class="">
                                    </hr>
                                </div>
                            </div>
