<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Edit Akun Aktivasi </h6>
        </div>
        <div class="card-body">
            <form method="post" action="<?= base_url('Admin/updateakunaktivasi/'); ?>">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <div class="form-check">
                            <div>
                                <input class="form-check-input" type="radio" id="id_role" name="id_role" value="3" checked>Bekukan!
                            </div>
                            <div>
                                <input class="form-check-input" type="radio" id="id_role" name="id_role" value="2">Aktivasi!
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="modal-footer">
                    <a href="<?= base_url('Admin/DaftarAkunAktivasi'); ?>"><button type="button" class="btn btn-secondary float-left">Kembali</button></a>
