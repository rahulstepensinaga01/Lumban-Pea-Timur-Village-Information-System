<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form method="post" action="<?= base_url('Admin/updatedaftarakun/'); ?>">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <div class="form-check">
                            <div>
                                <input class="form-check-input" type="radio" id="id_role" name="id_role" value="1">Aktivasi jadi Admin!
                            </div>
                            <div>
                                <input class="form-check-input" type="radio" id="id_role" name="id_role" value="2" checked>Aktivasi!
                            </div>
                            <div>
                                <input class="form-check-input" type="radio" id="id_role" name="id_role" value="3">Bekukan!
                            </div>
                        </div>
                    </div>
                </div>
